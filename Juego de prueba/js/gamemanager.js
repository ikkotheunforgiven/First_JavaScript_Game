let GameManager = {
    ...
    resetPlayer: function(classType) {
        switch (classType) {
            ...
            case "Rogue":
                ...
                break;
            case "Tank":
                player = new Player(classType, 600, 0, 200, 100, 50);
                break;
            case "Mage":
    ...
    setPreFight: function() {
        ...
        getHeader.innerHTML = '<p>Misión: Encuentra un enemigo.</p>';
        getActions.innerHTML = '<a href="#" class="btn-prefight" onclick="GameManager.setFight()">Buscar un enemigo</a>';
    ...
    setFight: function() {
        ...
        // Create enemy
        let enemy00 = new Enemy("Slime", 100, 0, 50, 100, 100);
        let enemy01 = new Enemy("Zombie", 200, 0, 150, 80, 100);
        ...
        getHeader.innerHTML = '<p>Misión: Elige tu movimiento</p>';
        getActions.innerHTML = '<a href="#" class="btn-prefight" onclick="PlayerMoves.calcAttack()">Atacar</a>';
